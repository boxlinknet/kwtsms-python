...
def _run_setup(env_file: str = ".env") -> None:
    ...
    # Sanitize: strip newlines to prevent credential values from breaking .env file format
    username     = username.replace('\r', '').replace('\n', '')
    password     = password.replace('\r', '').replace('\n', '')
    sender_id    = sender_id.replace('\r', '').replace('\n', '')
    log_file_path = log_file_path.replace('\r', '').replace('\n', '')
